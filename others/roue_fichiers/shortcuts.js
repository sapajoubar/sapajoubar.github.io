...
}var h="";if(navigator.userAgent.match(/AppleWebKit/i)&&!(navigator.userAgent.match(/Chrome/i)&&navigator.userAgent.match(/win/i))){l.setAttribute("type","search");
if(!l.getAttribute("results")){l.setAttribute("results",d)}if(null!=i){l.setAttribute("placeholder",i);
l.setAttribute("autosave",h)}l.onblur=function(){if(!SearchShortcut.itemSelected){SearchShortcut.hideResults()
}}}else{l.setAttribute("autocomplete","off");e=document.createElement("input");
l.setAttribute("type","text");l.parentNode.replaceChild(e,l);var b=document.createElement("span");
b.className="left";var j=document.createElement("span");j.className="right";var g=document.createElement("div");
